...
console.log(validationComposite.validate('CarlinhosDaVan123@email.com'));


// nesse exemplo da internet a gente basicamente cria algumas validações e usa o validationComposite para usar todas no testar
// se a string passada é um email. 